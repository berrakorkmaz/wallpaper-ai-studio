...
export default function StudioApp() {
  ...
  useEffect(() => { void getPublicRenderConfig().then(setRenderConfig).catch(() => setRenderConfig({ mode: "demo", provider: "mock", productionReady: false, falConfiguration: "not-selected", missingConfiguration: [] })); }, []);
