...
export const MOCKUP_CATEGORIES = ["Nursery", "Kids Room", "Living Room", "Bedroom", "Gaming Room", "Office / Studio", "Bathroom / Powder", "Dining / Entryway"] as const;
